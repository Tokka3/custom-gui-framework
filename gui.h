...
ImU32 accent = IM_COL32(137, 192, 74, 255);

struct DropDown {
    bool isClicked = false;
};
DropDown* DDList = new DropDown[50];
namespace MG { // menu globals
    POINT storeCP;
...
public:
    ...
    bool CIN(int x, int y, int w, int h) { // cursor in region
        GetCursorPos(&MG::cp);
    ...
    void Begin() {
        ...
        DrawImage(IMG::GHLogo, 5, -10, 50, 50);
        DrawGradient(0, 31, 600, 10, IM_COL32(0, 0, 0, 0), IM_COL32(0, 0, 0, 0), IM_COL32(137, 192, 74, 100), IM_COL32(137, 192, 74, 100));
        DrawRect(0, 30, 600, 1, 0, IM_COL32(137, 192, 74, 255));
